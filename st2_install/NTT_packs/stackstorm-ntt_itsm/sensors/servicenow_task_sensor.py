...
__all__ = [
    'servicenowtasksensor'
]


class servicenowtasksensor(PollingSensor):
    def __init__(self, sensor_service, config=None, poll_interval=None):
        super(servicenowtasksensor, self).__init__(sensor_service=sensor_service,
                                                       config=config,
    ...
    def poll(self):
        ...
        # Query for all active and open Tasks   
        sn_task_endpoint = '/api/now/table/sc_task?sysparm_query=active=true^state=1' 
        sn_task_endpoint = sn_task_endpoint + '^company.sys_id='+self.som_company_sys_id
        sn_task_endpoint = sn_task_endpoint + '^short_descriptionENDSWITHAUTO'
    ...
    def check_tasks(self, sn_taks):
        ...
        '''
        inc_st2_key = 'servicenow.tasks_processing'
        ...
        for tsk in sn_taks:
            ...
            if tsk['number'] in processing_tsks:
                ...
                self._logger.info('Processing tasks: ' + tsk['number'])
