...
KEY_DICT = {
    'servicenow': 'servicenow.incidents_processing',
    'helix': 'helix.incidents_processing'
}


class ITSMProcessingIncsRemove(BaseAction):
    def __init__(self, config):
        """Creates a new Action given a StackStorm config object (kwargs works too)
        :param config: StackStorm configuration object for the pack
        :returns: a new Action
        """
        super(ITSMProcessingIncsRemove, self).__init__(config)
