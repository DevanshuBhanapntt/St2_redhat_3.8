...
from servicenow_incident_update import ServiceNowIncidentUpdate
from st2common.runners.base_action import Action
import mock

__all__ = [
    'ServiceNowIncidentUpdateTestCase'
]


class ServiceNowIncidentUpdateTestCase(NTTBaseActionTestCase):
    __test__ = True
    action_cls = ServiceNowIncidentUpdate

    def test_init(self):
        action = self.get_action_instance(self.config_good)
        self.assertIsInstance(action, ServiceNowIncidentUpdate)
