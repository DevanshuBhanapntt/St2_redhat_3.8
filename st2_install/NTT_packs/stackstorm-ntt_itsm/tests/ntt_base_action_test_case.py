...
class NTTBaseActionTestCase(BaseActionTestCase):
    ...
    def setUp(self):
        ...
        self._config_no_tool = self.load_yaml('config_no_tool.yaml')
        self._config_no_creds = self.load_yaml('config_no_creds.yaml')
    ...
    @property
    def config_no_tool(self):
        return self._config_no_tool

    @property
    def config_no_creds(self):
        return self._config_no_creds
