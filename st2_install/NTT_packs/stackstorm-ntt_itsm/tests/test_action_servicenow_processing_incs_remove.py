...
from servicenow_processing_incs_remove import ServicenowProcessingIncsRemove
from st2common.runners.base_action import Action
import mock

__all__ = [
    'ServicenowProcessingIncsRemoveTestCase'
]


class ServicenowProcessingIncsRemoveTestCase(NTTBaseActionTestCase):
    __test__ = True
    action_cls = ServicenowProcessingIncsRemove

    def test_init(self):
        action = self.get_action_instance(self.config_good)
        self.assertIsInstance(action, ServicenowProcessingIncsRemove)
